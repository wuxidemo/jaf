...
public class QiniuUploadConfig {
	...
	public static final String ACCESS_KEY = "u-dPqHt7teVVWWMivJi9y4RN_Wer-vX7AEbVu6lB";// "wFqFOBsGN8lTaj-vBUl2w0bFMmK7WHTPiXG8TLPX";
	public static final String SECRET_KEY = "itqY7Ma8Lww1TrOSR5vKeq1a7sYgFcIRncykHh4u";// "EXDSHOYYuJdFOX-tZNuina8vR2WUtLEgM5pdwwWd";
	public static final String bucketName = "lyfpub";// "openduyexu";
	...
	public static String uploadFile(String filePath, String key)
		...
		Mac mac = new Mac(QiniuUploadConfig.ACCESS_KEY,
				QiniuUploadConfig.SECRET_KEY);
		// 请确保该bucket已经存在
	...
	public static String doQiniuPost(String host, String path, String param) {
		...
		try {
			...
			conn.setRequestProperty("Authorization", "QBox "
					+ QiniuUploadConfig.getAccessToken("/" + path, param));
	...
	public static Entry getFileInfo(String key) {
		...
		return client.stat(QiniuUploadConfig.bucketName, key);
	}
	...
	public static CallRet deleteFile(String key) {
		Mac mac = new Mac(QiniuUploadConfig.ACCESS_KEY,
				QiniuUploadConfig.SECRET_KEY);
		RSClient client = new RSClient(mac);
		return client.delete(QiniuUploadConfig.bucketName, key);
