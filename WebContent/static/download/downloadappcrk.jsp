...
<html>
<head>
<title>下载金阿福设备管理助手</title>
<meta http-equiv="refresh" content="0; url=http://soft.do-wi.cn/nsh/static/app/beacon.apk"/>
...
<div style="text-align: center; width:320px;overflow: hidden;margin : 30% auto;" >
	<h3 align="center">免费下载设备管理助手</h3>
	<br/>
	<a href="http://soft.do-wi.cn/nsh/static/app/beacon.apk" target="_blank"> 
...
<script type="text/javascript">
		...
		var browser = {
			...
			if (browser.versions.ios || browser.versions.iPhone
				...
				window.location = "iosNotSupport.jsp";
