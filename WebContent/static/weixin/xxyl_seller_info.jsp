...
<script type="text/javascript" src="http://stc.weimob.com/src/microtakeout/swipe_min.js?2014-05-21"></script>
...
$(document).ready(function(){
	...
	/* 		str += "<li>";
			str += "	<a href=\"javascript:;"\">";
			str += "		<span><i class=\"ico_tel\"></i></span>";
			...
			/* img += "<li><a href=\"javascript:;\"><img src=\""+temp.url+"\" /></a></li>";
			$("#imgSwipe1").append(img); */
...
<body onselectstart="return true;" ondragstart="return false;">
	...
	<header class="nav">
		<div>
			<a href="javascript:;" onclick="toMenu()">项目列表</a>
			<a href="javascript:;" class="on">商家详情</a>
		</div>
	</header>
	<section>
		<div id="imgSwipe1" class="img_swipe1">
			 <ul>
	...
	<footer class="go_menu">
		<div class="fixed">
			<a href="javascript:;" onclick="showSuccess()">返回商家列表</a>
		</div>
	</footer>
</div></body>
<script type="text/javascript">
function showSuccess() {
	window.location.href = "${ctx}/static/weixin/xxyl_seller_list.jsp";
}
</script>
<script type="text/javascript">
(function() {
