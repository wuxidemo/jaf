...
$(document).ready(function(){
	...
	$.get('${ctx}/api/cyms/detail/tese?clientid=00:00:00:00:00:01&sellerid='+sellerid,function(map){
		if(map["data"] != null && map["data"] != '') {
			...
			for(var i=0;i< map["data"].length; i++) {
				...
				str += "	<div>";
				str += "		<img src=\""+temp.url+"\"  width=\"65px\" height=\"65px\" url=\""+temp.url+"\"/>";
				str += "	</div>";
				str += "	<div>";
				str += "		<h3>"+temp.name+"</h3>";
				str += "		<p>月售<span class=\"sale_num\">"+temp.sales+"</span>份<span class=\"sales\"><strong class=\"sale_10\"></strong></span></p>";
				...
				str += "		<strong>&yen;<span class=\"unit_price\">"+temp.price+"</span></strong>";
			 	...
			 	str += "			<span style=\"\">";
			 	str += "				<a class=\"btn del active\" href=\"javascript:void(0);\"></a>";
	...
	$.get('${ctx}/api/cyms/detail/tejia?clientid=00:00:00:00:00:01&sellerid='+sellerid,function(map){
		if(map["data"] != null && map["data"] != '') {
			var str = '';
			for(var i=0;i< map["data"].length; i++) {
				var temp = map["data"][i];
	...
	$.get('${ctx}/api/cyms/detail/paihang?clientid=00:00:00:00:00:01&sellerid='+sellerid,function(map){
		if(map["data"] != null && map["data"] != '') {
			var str = '';
			for(var i=0;i< map["data"].length; i++) {
				var temp = map["data"][i];
...
function toMendian() {
	var sellerid = $("#sellerid").val();
	window.location.href = "${ctx}/static/weixin/cyms_seller_info.jsp?sellerid="+sellerid;
}

function showDetail(proid) {
	var sellerid = $("#sellerid").val();
	window.location.href = "${ctx}/static/weixin/cyms_pro_detail.jsp?proid="+proid+"&sellerid="+sellerid;
}

var num = 0;
function tip() {
	if(num == 0) {
		alert("预约成功，请尽快就餐，两个小时未至，此次预约将失效！");
		num += 1;
	}else{
		alert("你已经预约成功，请不要重复预约！就餐时关注本店微信号，可享受饮料，酒水85折优惠！");
	}
...
<body onselectstart="return true;" ondragstart="return false;">
	...
	<section class="menu_wrap" id="menuWrap">
		<div id="menuNav" class="menu_nav">
			...
			<!-- <div class="side_nav" id="sideNav">
				<ul>
					<li><a href="javascript:void(0);">特色菜</a></li>
					<li><a href="javascript:void(0);">特价菜</a></li>
					<li><a href="javascript:void(0);">畅销菜 </a></li>
				</ul>
			</div> -->
		</div>		
		<div class="menu_container">
			<div class="menu_tt"><h2 class="">特色菜</h2></div>
			<ul class="menu_list" id="tese">
				<!-- <li>
					<div>
					...
					<div>
						<h3>鲫鱼炖豆腐</h3>
						<p>月售<span class="sale_num">70</span>份<span class="sales"><strong class="sale_10"></strong></span></p>
						<div class="info"></div>
					</div>
					<div class="price_wrap">
						<strong>&yen;<span class="unit_price">28</span></strong>
						<div class="fr" max="-1">
							<a href="javascript:void(0);" class="btn add"></a>
						</div>
						<input autocomplete="off" class="number" type="hidden" name="dish[1218][woi_number]" value="" />
						<input autocomplete="off" type="hidden" name="dish[1218][wdd_name]" value="鲫鱼炖豆腐" />
						<input autocomplete="off" type="hidden" name="dish[1218][wdd_price]" value="28" />
					</div>
				</li>
			...
			<div class="menu_tt"><h2 class="">特价菜</h2></div>
			<ul class="menu_list" id="tejia">
				<!-- <li>
					<div>
						<img src="http://hs-album.oss.aliyuncs.com/static/1c/38/3c/image/20140729/20140729173419_43894.jpg" alt="" url="http://hs-album.oss.aliyuncs.com/static/1c/38/3c/image/20140729/20140729173419_43894.jpg" />
					</div>
					<div>
						<h3>干锅茶树菇</h3>
						<p>月售<span class="sale_num">5</span>份<span class="sales"><strong class="sale_10"></strong></span></p>
						<div class="info"></div>
					</div>
					<div class="price_wrap">
						<strong>&yen;<span class="unit_price">28</span></strong>
						...
						<input autocomplete="off" class="number" type="hidden" name="dish[1129][woi_number]" value="" />
						<input autocomplete="off" type="hidden" name="dish[1129][wdd_name]" value="干锅茶树菇" />
						<input autocomplete="off" type="hidden" name="dish[1129][wdd_price]" value="28" />
					</div>
				</li> -->
			</ul>
			<div class="menu_tt"><h2 class="">畅销菜</h2></div>
			<ul class="menu_list" id="paihang">
				<!-- <li>
					<div>
						<img src="http://hs-album.oss.aliyuncs.com/static/1c/38/3c/image/20140729/20140729173239_98457.jpg" alt="" url="http://hs-album.oss.aliyuncs.com/static/1c/38/3c/image/20140729/20140729173239_98457.jpg" />
					</div>
					<div>
						<h3>鱼香茄子</h3>
						<p>月售<span class="sale_num">4</span>份<span class="sales"><strong class="sale_0"></strong></span></p>
						<div class="info"></div>
					</div>
					<div class="price_wrap">
						<strong>&yen;<span class="unit_price">14</span></strong>
						<div class="fr" max="-1">
							<a href="javascript:void(0);" class="btn add"></a>
						</div>
						<input autocomplete="off" class="number" type="hidden" name="dish[1126][woi_number]" value="" />
						<input autocomplete="off" type="hidden" name="dish[1126][wdd_name]" value="鱼香茄子" />
						<input autocomplete="off" type="hidden" name="dish[1126][wdd_price]" value="14" />
					</div>
				</li> -->
			</ul>
			<div class="menu_tt"><h2 class=""></h2></div>
			<ul class="menu_list">
			</ul>
		</div>
	</section>
	<footer class="shopping_cart">
		<div class="fixed">
			...
			<div>&yen;<span id="totalPrice">0</span></div> -->
			<div>
				<!-- <span class="comm_btn disabled"  style="display: none;">还差<span id="sendCondition">0</span>起送</span> -->
				<a id="settlement" href="javascript:;" class="comm_btn" onclick="tip()">预约餐桌</a>
			</div>
		</div>
	</footer>
	...
	<input autocomplete="off" name="cart_total_price" type="hidden" value="0"/> 
		...
		<!-- <div class="dialog mask" style="display: none;">
			<div class="dialog_wrap"  style="display: none;">
				<div class="dialog_tt" style="display: none;">鲫鱼炖豆腐</div>
				<a href="javascript:void(0);" class="dialog_close"></a>
				<div class="dialog_scroller">
					<div style="display: none;" class="menu_detail dialog_content"
						id="menuDetail">
						<img
							src="http://hs-album.oss.aliyuncs.com/static/1c/38/3c/image/20140729/20140729180258_59697.jpg"
							style="">
						<div style="display: none;" class="nopic"></div>
						...
						<p>
							月售<span class="sale_num">9</span>份<span class="sales"><strong
								class="sale_0"></strong></span>
						</p>
						<dl>
							<dt>介绍：</dt>
							<dd class="info"></dd>
