...
<title>上传个人信息</title>
<link type="text/css"
	href="${ctx}/static/wxfile/newyear/css/personalinformation.css"
	rel="stylesheet" />
</head>
<body>
	<div id="all"></div>
	...
	<div id="whole_head">
		<div>
			<img id="tianjia" src="../static/wxfile/newyear/image/shangchuan.png">
		</div>
	</div>
		...
		<div id="whole_middle">
			...
			<div id="middltext">
				<div id="middltext_l">
					...
					<input id="shouji" type="text" onblur="phone()" value=""
			...
			<div id="middltext">
				...
				<textarea id="zpjs" type="textarea" maxlength="50"
					onblur="introduce()" name="context"></textarea>
			</div>
...
$(document).ready(function(){
	/**	wxyt({
	 div : "tianjia",
	 baseurl : "${ctx}",
	 tip : "(支持gif,jpg,png格式.推荐大小720*395)",
	
	 sucess : function(download_url, fileid, url) {
	 var oImg = document.getElementById("tianjia");
	 oImg.src = download_url;
	 $("#a").val(download_url+"?imageView2/2/w/150");
	 $("#tianjia").css("width", "25%");
	 $("#tianjia").css("height", "auto");
	 //$("#tianjia").html("<img id='tianjia' src="+download_url+" style=\"width:360px;\"/></div>");
	 //$("#tianjia").val(download_url);       
	 },
	 fail : function(d) {
	 $("#all").show();
	 $("#xmbnwk").show();
		...
		var options = {
			...
			success : function(data) {
				...
				if (data.result == 2) {
					...
					$("#tjsb_up").show();
					$("#tjsb_down").show();
					document.getElementById("tjsb_up").innerHTML = "上传失败,请重";
						...
						success : function(res) {
							...
							wx.uploadImage({
								...
								success : function(res) {
									...
									$.post("${ctx}/newyearact/saveimg?sid="
											+ serverId, function(d) {
										if (d == null) {
											$("#all").show();
											$("#xmbnwk").show();
