...
<meta
	...
	name="viewport">
<title>最美服务员上传个人信息</title>
<link type="text/css"
	href="${ctx}/static/wxfile/newyear/css/waiterinformation.css"
	rel="stylesheet" />
</head>
<body>
	<div id="all"></div>
		...
		<div id="whole_middle">
			<div id="middltext">
				<div id="middltext_l">
					...
					<input id="xm" type="text" maxlength="5" onblur="nam()" name="name" placeholder="请输入真实姓名">
				</div>
			</div>
			<div id="middltext">
				<div id="middltext_l">
					...
					<input id="shouji" type="text" onblur="phone()" value=""
						maxlength="11" name="telephone" placeholder="输入有效手机号码">
				</div>
			</div>
			<div id="middltext">
				<div id="middltext_l">
					<div class="middltext_div">店铺名称&nbsp;:</div>
					<input id="dpmc" type="text" onblur="shopName()" value=""
						maxlength="10" name="mername" placeholder="不超过10个字">
				</div>
			</div>
			<div id="middltext">
				<div id="middltext_l">
					...
					onblur="individual()" name="context" placeholder="不超过20个字"></textarea>
				</div>
			</div>
			<div id="middltext">
				<div id="middltext_l">
			...
			<input id="a" name="url" onchange="tupian()">
			<div id="whole_foot">
...
$(document).ready(function(){
	...
	bindshow("#tianjia");
	$("#tianjia").attr("src","${ctx}/static/wxfile/newyear/image/shangchuan_2.png");
});
