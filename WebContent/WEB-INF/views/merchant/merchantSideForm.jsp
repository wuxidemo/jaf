...
<script>
	...
	function formsubmit() {
		...
		if($.trim(specialcourse) == '') {
			window.parent.showAlert("请填写本店特色");
			return false;
		} 
...
<body>
	...
	<div class="portlet box grey">
		...
		<div class="portlet-body form">
			<form action="${ctx}/merchant/mersideupdate" id="inputForm" class="form-horizontal" method="post">
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="checkbox">
							<input type="checkbox" id="bmer" disabled="disabled" name="bmer" <c:if test="${merchant.business != null }">checked="checked" value="1"</c:if> <c:if test="${merchant.business == null }">value="0"</c:if> /> 商圈商户
						</label>
						<label class="checkbox">
							<input type="checkbox" id="cmer" disabled="disabled" name="cmer" <c:if test="${merchant.community != null }">checked="checked" value="1"</c:if> <c:if test="${merchant.community == null }">value="0"</c:if> /> 社区商户
						</label>
					</div>
				</div>
				...
				<div class="control-group">
					<label class="control-label">&nbsp;本店特色:</label>
					<div class="controls">
