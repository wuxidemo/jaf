...
<body style="margin: 0px;">
	...
	<div id="ding">
		...
		<div style="font-size: 25px; color: #FCE660; padding-top:130px;text-align: center;color: red;">
	...
	<div id="id1">
		...
		<div style="width: 100%; height: 75px;">
			<input type="text" name="num" id="num" placeholder="请填写正确手机号码"
				maxlength="11" value="${wr.phone}" <c:if test="${wr.phone!=null and wr.phone!=''}">disabled='disabled'</c:if>>
		</div>
		
		<div style="width: 100%; height: 75px;">
			
			<c:choose>
				<c:when test="${wr.phone!=null and wr.phone!=''}">
					<div
				...
				<c:otherwise>
					<div
				     style="width: 80%; height: 40px; background-color:red;border-radius:0.6em; margin: 21px auto; line-height: 40px;color: white;"onclick="formsubmit()">
				提交</div>
				</c:otherwise>
			</c:choose>
		</div>
