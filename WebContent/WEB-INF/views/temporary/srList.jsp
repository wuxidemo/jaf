...
<script type="text/javascript">
	$(document).ready(function() {
		$("#over").bind("click", function() {
			$.post("${ctx}/sharerecord/stop", function(d) {
				if (d == "1")
...
<body>
		...
		<div class="span12">
			<h3 class="page-title">
				<img src="${ctx}/static/images/shgl.png"
					style="vertical-align: text-bottom;" />分享活动
			</h3>
		</div>
	</div>
	...
	<div class="portlet box grey" style="margin-bottom: 0px; height: auto;">
		...
		<div class="portlet-body" style="padding-top: 25px;">
			<form class="form-search" id="myform" action="${ctx}/sharerecord" method="post">
	...
	<div class="portlet box grey">
		<div class="portlet-title">
			...
			<div class="actions">
				<a href="${ctx}/sharerecord/redbag" class="btn blue">红包记录</a> <a
					href="${ctx}/sharerecord/srcj" class="btn blue">抽奖</a> <a id="over"
					href="javascript:void(0);" class="btn blue">活动结束</a>
			</div>
		</div>
		<div class="portlet-body">
			...
			<div id="message" class="alert alert-success">
				参与活动的人数为：<span style="color:red; font-size:20px;">${srs.totalElements}</span>
			</div>
						...
						<c:forEach items="${srs.content}" var="tr" varStatus="status">
							<tr>
								<td><input type="checkbox" id="check_item" value="${tr.id}"
									class="check_item"></td>
								<td style="vertical-align: middle;">${tr.id}</td>
