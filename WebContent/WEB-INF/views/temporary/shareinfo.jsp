...
<body style="margin: 0px;">
	...
	<div style="width: 100%;height: auto;">
	    <img src="${ctx}/static/11act/images/qietu4-1.png" style="width: 100%;">
	</div>
	...
	<!-- <div style="width: 100%;height: auto;">
	      <div style="width: 90%;height: auto; -webkit-border-radius: 20px 20px 20px 20px;background-color:#F9C54B ;margin-left:auto;margin-right: auto;margin-top: 0px;margin-bottom: 0px;">
	          <div style="width:90%;height: auto;margin-left:auto;margin-right: auto;margin-top: 0px;margin-bottom: 0px;">
	          <p style="color: red;font-size: 20px;">关注+分享活动规则:</p>
	          <table>
	             <tr>
	               <td style="vertical-align: top;">1.</td>
	               <td>活动时间为2015年11月1日至11月11日.</td>
	             </tr>
	              <tr>
	               <td style="vertical-align: top;">2.</td>
	               <td>每天前3000名分享的用户可获得红包.</td>
	             </tr>
	              <tr>
	               <td style="vertical-align: top;">3.</td>
	               <td>同一微信ID只可获得一次红包.</td>
	             </tr>
	              <tr>
	               <td>4.</td>
	               <td>每天分享可参与每天的抽奖.</td>
	              ...
	              <tr>
	               ...
	               <td>随机抽取幸运粉丝，获奖名单于次日在本微信公众平台公布</td>
	             </tr>
	              <tr>
	               <td>6.</td>
	               <td>在法律范围内，最终解释权归主办方</td>
	             </tr>
	          </table>
	          </div>
	      </div>
	...
	<%-- <div style="width: 100%;height:600px;background: url('${ctx}/static/11act/images/gz4.jpg');filter:'progid:DXImageTransform.Microsoft.AlphaImageLoader(sizingMethod='scale ')';-moz-background-size: 100% 100%;background-size: 100% 100%;margin-top: 15px;">
																				...
																				if (d.luck != null) {
																					if (d.redbag != null) {
																						...
																						if(d.redbag=="1")
																							...
																							str = "红包发送失败，9点后我们将给您补发，您已自动参与当日系统抽奖，您的券码是"+d.luck;
																							}
