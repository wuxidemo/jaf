...
<body>
	<div data-role="page"
		...
		<div style="width: 100%;">
			<c:if test="${fn:indexOf(advert.img,'http://') >=0 }">
				<img src="${advert.img}" width="100%" heigth="100%">
			</c:if>
			<c:if test="${fn:indexOf(advert.img,'http://') <0 }">
				<img src="${ctx}/${advert.img}" width="100%" heigth="100%">
			</c:if>
		</div>
		...
		<div
			...
			class="contentdiv">
			<div class="innerdiv">${advert.content }</div>
		</div>
	</div>
