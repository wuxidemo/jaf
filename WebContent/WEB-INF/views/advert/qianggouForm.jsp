		...
		<div class="portlet-body form">
			<form action="${ctx}/advert/savequickbuy" id="inputForm" class="form-horizontal" method="post">
				...
				<div class="control-group" id="imgfacediv">
					...
					<div class="controls">
						<img src="${ctx}/static/images/zanwuPic.jpg" id="adimg" style="width:300px;height:200px;" />
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" id="paymoney" class="span3 m-wrap" style="width: 60%;" name="paymoney2" value="" maxlength="10">
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" id="amount" class="span3 m-wrap" style="width: 60%;" name="amount" value="" maxlength="10">
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" id="title" class="span3 m-wrap" style="width: 60%;" name="title" value="" maxlength="30">
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" id="subtitle" class="span3 m-wrap" style="width: 60%;" name="subtitle" value="" maxlength="30">
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" id="buttontext" class="span3 m-wrap" style="width: 60%;" name="buttontext" value="" maxlength="10">
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<select class="span2 m-wrap required" id="cardid" style="width: 60%;" name="cardid">
